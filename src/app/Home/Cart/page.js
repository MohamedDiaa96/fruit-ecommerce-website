        ...
        <div >
            ...
            <div className="flex justify-center items-center h-[900px] flex-col min-sm:max-xl:w-[100%]">
                ...
                <div className="h-[672px] w-[1300px] flex flex-col bg-[#F7F7F8]  rounded-[5px] border-[1px] border-[#E9E9E9] overflow-y-scroll overflow-hidden min-sm:max-xl:w-[100%]">
                    ...
                    <div className="flex  items-center border-[1px] border-[#E9E9E9] bg-[#E9E9E9] py-4 h-[46px] ">
                        {/* labels */}
                        <div className="w-[518px] min-sm:max-xl:w-[468px] min-sm:max-xl:pl-10 pl-4">
                            {/* Product label */}
                    ...
                    <div className="flex flex-col ">
                        ...
                        {cartitems.length === 0 ? (
                            ...
                            <div className="flex items-center gap-[20px] w-[495px] min-sm:max-xl:mx-5">
                                {/* image and title */}
                                <Image src={item.img} width={60} height={60} alt={item.title} className="rounded-[5px] border border-[#E9E9E9]"></Image>
                                <h1 className=" font-[Segoe_UI] font-normal text-[14px] leading-[21px] tracking-[0.6px] align-middle text-[#444444]">{item.title}</h1>
                            </div>
                            <div className="min-sm:max-xl:mx-5 w-[40px]">
                                {/* cart price */}
                            ...
                            <div className="w-[231.63999938964844px] flex  justify-end min-sm:max-xl:mx-5">
                                ...
                                <div className="w-[80px] h-[30px] cursor-pointer flex items-center justify-between px-1 rounded-[5px] border-[1px] border-[#E9E9E9]">
                                    ...
                                    <button onClick={() => increasequantity(item.id)} className="active:bg-[#00000051] overflow-hidden content-center font-[Segoe_UI] h-full w-5  cursor-pointer font-normal text-[16px] leading-6 tracking-[0%] text-center align-middle text-black">+</button>
                                    ...
                                    <button onClick={() => { decreasequantity(item.id) }} className="font-[Segoe_UI] active:bg-[#00000051] overflow-hidden content-center  h-full w-5  cursor-pointer font-normal text-[16px] leading-6 tracking-[0%] text-center align-middle text-black">-</button>
                                </div>
                            </div>
                            <div className="w-[256.6699981689453px] min-sm:max-xl:pl-[13%]  flex pl-50 justify-start">
                                {/* total price */}
                            ...
                            <div className="w-[180px] justify-end min-sm:max-xl:justify-start min-sm:max-xl:pl-[10%] flex">
                                {/* remove cart item */}
