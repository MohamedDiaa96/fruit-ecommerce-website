...
export default function ButtonUI({ buttontype, text, onclick, className }) {


    return (
        <button onClick={onclick} className={`${className} relative cursor-pointer group flex items-center justify-center gap-[5px] rounded-lg overflow-hidden bg-[#F53E32] ${text === "Add" ? "w-[84.91000366210938px] h-9" : text === "Add To Cart" ? "w-[188px] h-[31px]" : "w-[105px] h-[31px]"}  text-white font-quicksand font-bold text-[12px] leading-[15px] tracking-[0.5px] align-middle`}>
            ...
            {buttontype === "A" ? (<>{(text === "Add" || text === "Add To Cart") && (<svg viewBox="0 0 15 15" className="w-[15px] h-[15px] z-20" fill="white" xmlns="http://www.w3.org/2000/svg">
