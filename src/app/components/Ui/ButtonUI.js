...
export default function ButtonUI({ buttontype, text, onclick }) {
    ...
    return (
        <button onClick={onclick} className={`relative cursor-pointer group flex items-center justify-center gap-[5px] rounded-[4px] overflow-hidden bg-[#F53E32] ${text === "Add" ? "w-[84.91000366210938px] h-[36px]" : text === "Add To Cart" ? "w-[188px] h-[31px]" : "w-[105px] h-[31px]"}  text-white font-quicksand font-bold text-[12px] leading-[15px] tracking-[0.5px] align-middle`}>
